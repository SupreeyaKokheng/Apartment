...
@Entity
@Table(name = "water_meter", uniqueConstraints = @UniqueConstraint(columnNames = {"room_id", "recordDate"}))
public class WaterMeter {
    ...
    public WaterMeter(Room room, BigDecimal meterValue, LocalDate recordDate) {
        this.room = room;
